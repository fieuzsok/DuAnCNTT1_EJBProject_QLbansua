    ...
    <div class="col1">
        ...
        <ul>
            <c:forEach items ="${hangSuaLst}" var="hangSua" >
                <li><a href="trang-chu.jsp?maHang=${hangSua.ma_hang_sua}">${hangSua.ten_hang_sua}</a></li>
            </c:forEach>
        </ul>
        <p>Sản phẩm theo loại</p>
        <ul>
            <c:forEach items="${loaiSuaLst}" var="loaiSua" begin="0" step="1">
               <li><a href="trang-chu.jsp?maLoai=${loaiSua.ma_loai_sua}">${loaiSua.ten_loai}</a></li>
            </c:forEach>
        </ul>
    </div>
    <div class="col2">
        ...
        <div class="col21">
            <table border="1" width="100%">
                ...
                <tbody>
                    <c:forEach items ="${suaLst}"   var="dsSua" begin="0" end="4" step="1">    
                    <tr>
                        <td style="text-align: center;"><img src="./images/${dsSua.hinh}"/></td>
                        <td><a href="trang-thong-tin-sua.jsp?maSua=${dsSua.ma_sua}">${dsSua.ten_sua}</a></td>
                        <td style="text-align: right;">${dsSua.trong_luong}gam</td>
                        <fmt:setLocale value="vi-VN"></fmt:setLocale>
                        <fmt:formatNumber value="120000" var="donGia" type="number"></fmt:formatNumber>
                        <td style="text-align: right;">${dsSua.don_gia}VNĐ</td>
                    </tr>
                    </c:forEach>
                </tbody>
            </table>
